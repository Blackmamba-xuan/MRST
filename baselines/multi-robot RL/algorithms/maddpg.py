...
from SMART.baselines.utils.agents import DDPGAgent
...
class MADDPG(object):
    ...
    @classmethod
    def init_from_env(cls, agent_num=3, agent_alg="MADDPG",num_in_pol=363,num_out_pol=4,discrete_action=True,
