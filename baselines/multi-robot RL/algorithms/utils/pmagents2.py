...
class PMAgent(object):
    ...
    def __init__(self, num_in_pol, num_out_pol,attention_dim, num_in_pm, hidden_dim=16,
        ...
        self.pmNet_2 = MLPNetwork(num_in_pm, num_out_pol,norm_in=False,
                                  hidden_dim=hidden_dim,
                                  constrain_out=False)
        self.pmNet_3 = MLPNetwork(num_in_pm, num_out_pol,norm_in=False,
                                  hidden_dim=hidden_dim,
                                  constrain_out=False)
        ...
        self.pmNet_optimizer3 = Adam(self.pmNet_3.parameters(), lr=lr)
        self.EPSILON = 1.0
        self.EPS_MIN = 0.01
        self.EPS_DEC = 0.996
    ...
    def step(self, obs_x1,obs_x2, explore=False):
        ...
        if rand> self.EPSILON:
            ...
            action_prob3 = self.pmNet_3.forward(obs_x1)
            action_prob3_soft = torch.softmax(action_prob3, dim=1)
            partn_ac_prob=torch.cat((action_prob1_soft,action_prob2_soft),dim=1)
            partn_ac_prob = torch.cat((partn_ac_prob, action_prob3_soft), dim=1)
    ...
    def get_params(self):
        return {'policy': self.policy.state_dict(),
                ...
                'pmNet_3': self.pmNet_3.state_dict()
                }
    ...
    def load_params(self, params):
        ...
        self.pmNet_3.load_state_dict(params['pmNet_3'])