...
from SMART.baselines.utils.misc import soft_update, hard_update, enable_gradients, disable_gradients
from SMART.baselines.utils.agents import AttentionAgent
from SMART.baselines.utils.critics import AttentionCritic
...
class AttentionSAC(object):
    ...
    @classmethod
    def init_from_env(cls, env, agent_num=3,num_in_pol=363,num_out_pol=4,gamma=0.95, tau=0.01,
                      pi_lr=0.01, q_lr=0.01,
                      reward_scale=10.,
                      pol_hidden_dim=64, critic_hidden_dim=64, attend_heads=2,
                      **kwargs):
        """
        ...
        for agent_i in range(agent_num):
            ...
            sa_size.append((num_in_pol, num_out_pol))
