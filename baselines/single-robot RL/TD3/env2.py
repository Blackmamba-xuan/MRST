...
class Env(object):
    def __init__(self):
        ...
        self.init_pos=[[-0.551046,-0.439322,-0.001003,0.0025,0.0028,-0.6684,0.7437],[0.272933,-1.148728,-0.001003,-0.00084,0.00377,0.21591,0.97640],
                       [0.372298,0.331689,-0.001003,-0.0021,0.0032,0.5564,0.8308],[0.470092,0.980189,-0.001003,-0.0035,0.0015,0.9182,0.3960]]
        ...
        self.cur_center=500
        self.cv_image=np.zeros([1,60,100])
        self.counter=1
        self.rw_scale=20
        self.im_frames=[]
        self.stop_counter=0
    ...
    def imgCallback(self, image_msg):
        ...
        im = cv2.resize(cv_image, (100, 60), interpolation=cv2.INTER_AREA)
